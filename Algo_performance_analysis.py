...
quicksort_time = np.array(sort_times["Quick sorting time"])
mergesort_time = np.array(sort_times["Merge sorting time"])
...
plt.plot(array_size, mergesort_time, label="Megre sort")
...
plt.plot(array_size[0:50], mergesort_time[0:50], label="Merge sort")
...
plt.plot(array_size[0:15], mergesort_time[0:15], label="Merge sort")
